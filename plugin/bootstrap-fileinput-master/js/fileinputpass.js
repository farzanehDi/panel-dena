...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        browseLabel: '<span class="translable-visible-fa">آپلود عکس پاسپورت</span><span class="translable-visible-ar">تحميل جواز السفر</span><span class="translable-visible-gb">Upload Passport</span>',
