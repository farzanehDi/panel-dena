...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        //browseLabel: 'آپلود پاسپورت',
        browseLabel: '<span class="translable-visible-gb">Upload Passport</span><span class="translable-visible-fa">آپلود پاسپورت</span><span class="translable-visible-ar">تحميل جواز السفر</span>',
        removeLabel: '<span class="translable-visible-gb">Clear</span><span class="translable-visible-fa">پاکسازی</span><span class="translable-visible-ar">تنظيف</span>',
        ...
        msgFilesTooMany: 'Number of files selecteda for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.',
